...
abstract class ColissimowsFreeshipping implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\ColissimoWs\\Model\\Map\\ColissimowsFreeshippingTableMap';
    ...
    /**
     * Initializes internal state of ColissimoWs\Model\Base\ColissimowsFreeshipping object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>ColissimowsFreeshipping</code> instance.  If
     * <code>obj</code> is an instance of <code>ColissimowsFreeshipping</code>, delegates to
     * <code>equals(ColissimowsFreeshipping)</code>.  Otherwise, returns <code>false</code>.
     *
    ...
    public function setFreeshippingFrom($v)
    {
        ...
        if ($this->freeshipping_from !== $v) {
            ...
            $this->modifiedColumns[ColissimowsFreeshippingTableMap::FREESHIPPING_FROM] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ColissimowsFreeshippingTableMap::translateFieldName('FreeshippingFrom', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = ColissimowsFreeshippingTableMap::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ColissimowsFreeshippingTableMap::FREESHIPPING_FROM)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ColissimowsFreeshippingTableMap::FREESHIPPING_FROM)) $criteria->add(ColissimowsFreeshippingTableMap::FREESHIPPING_FROM, $this->freeshipping_from);
