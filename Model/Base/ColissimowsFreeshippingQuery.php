 ...
 * @method     ChildColissimowsFreeshippingQuery orderByFreeshippingFrom($order = Criteria::ASC) Order by the freeshipping_from column
 *
 ...
 * @method     ChildColissimowsFreeshippingQuery groupByFreeshippingFrom() Group by the freeshipping_from column
 *
 ...
 * @method     ChildColissimowsFreeshipping findOneByFreeshippingFrom(string $freeshipping_from) Return the first ChildColissimowsFreeshipping filtered by the freeshipping_from column
 *
 ...
 * @method     array findByFreeshippingFrom(string $freeshipping_from) Return ChildColissimowsFreeshipping objects filtered by the freeshipping_from column
 *
 */
abstract class ColissimowsFreeshippingQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT ID, ACTIVE, FREESHIPPING_FROM FROM colissimows_freeshipping WHERE ID = :p0';
        try {
    ...
    public function filterByFreeshippingFrom($freeshippingFrom = null, $comparison = null)
    {
        if (is_array($freeshippingFrom)) {
            ...
            if (isset($freeshippingFrom['min'])) {
                $this->addUsingAlias(ColissimowsFreeshippingTableMap::FREESHIPPING_FROM, $freeshippingFrom['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($freeshippingFrom['max'])) {
                $this->addUsingAlias(ColissimowsFreeshippingTableMap::FREESHIPPING_FROM, $freeshippingFrom['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(ColissimowsFreeshippingTableMap::FREESHIPPING_FROM, $freeshippingFrom, $comparison);
    }
