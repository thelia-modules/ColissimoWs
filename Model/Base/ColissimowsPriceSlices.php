...
abstract class ColissimowsPriceSlices implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\ColissimoWs\\Model\\Map\\ColissimowsPriceSlicesTableMap';
    ...
    /**
     * Initializes internal state of ColissimoWs\Model\Base\ColissimowsPriceSlices object.
     */
    ...
    /**
     * Compares this with another <code>ColissimowsPriceSlices</code> instance.  If
     * <code>obj</code> is an instance of <code>ColissimowsPriceSlices</code>, delegates to
     * <code>equals(ColissimowsPriceSlices)</code>.  Otherwise, returns <code>false</code>.
     *
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            return $startcol + 5; // 5 = ColissimowsPriceSlicesTableMap::NUM_HYDRATE_COLUMNS.
