...
class ColissimowsFreeshippingTableMap extends TableMap
{
     ...
     */
    const FREESHIPPING_FROM = 'colissimows_freeshipping.FREESHIPPING_FROM';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(ColissimowsFreeshippingTableMap::ID, ColissimowsFreeshippingTableMap::ACTIVE, ColissimowsFreeshippingTableMap::FREESHIPPING_FROM, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(ColissimowsFreeshippingTableMap::ID => 0, ColissimowsFreeshippingTableMap::ACTIVE => 1, ColissimowsFreeshippingTableMap::FREESHIPPING_FROM => 2, ),
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ColissimowsFreeshippingTableMap::FREESHIPPING_FROM);
        } else {
